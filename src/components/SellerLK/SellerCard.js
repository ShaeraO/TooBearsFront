  ...
  return (
    <Section>
        ...
        <TextBlock>
            ...
            <MenuSeller>
                <Link to="Orders"><ButtonMenu><img src="https://svgshare.com/i/iBj.svg" alt='present' /><span>Заказы</span></ButtonMenu></Link>
                ...
                <Link to="Favorite"><ButtonMenu>Избранное</ButtonMenu></Link>
                <Link to="Settings"><ButtonMenuBottom>Настройки</ButtonMenuBottom></Link>
            </MenuSeller>
        </TextBlock>
    </Section>
  )
